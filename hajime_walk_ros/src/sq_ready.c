  ...
  switch (mode_sq_ready)
  {
    case SQ_READY: /*	ready position	*/
      ...
      xv_data_x_r.time = xv_data_y_r.time = xv_data_y_r2.time = xv_data_z_r.time = xv_data_x_l.time = xv_data_y_l.time =
          xv_data_y_l2.time = xv_data_z_l.time = xv_mv_ready_time;
    ...
    case SQ_READY2: /*	ready position	*/
      /* action */
      xv_data_pitch.time = xv_data_roll2.time = xv_mv_ready_time;
    ...
    case SQ_READY3: /*	ready position	*/
      /* action */
      xv_data_d[LEG_YAW_L].time = xv_data_d[LEG_YAW_R].time = xv_data_d[12].time = xv_data_d[13].time =
          xv_mv_ready_time;

      xv_data_d[LEG_YAW_L].pos = xv_data_d[LEG_YAW_R].pos = xv_data_d[12].pos = xv_data_d[13].pos = 0.f;

      xv_data_d[ELBOW_PITCH_L].time = xv_data_d[ELBOW_PITCH_R].time = xv_data_d[ARM_PITCH_L].time =
    ...
    case SQ_READY4: /*	ready position	*/
      ...
      {
        xv_data_d[HEAD_YAW].time = xv_data_d[HEAD_PITCH].time = xv_mv_ready_time;
        xv_data_d[HEAD_YAW].pos = xv_data_d[HEAD_PITCH].pos = 0.f;
      }

      xv_data_d[ARM_ROLL_L].time = xv_data_d[ARM_ROLL_R].time = xv_mv_ready_time;

      xv_data_d[ARM_ROLL_L].pos = -xp_mv_ready.arm_sh_roll;
      xv_data_d[ARM_ROLL_R].pos = xp_mv_ready.arm_sh_roll;

      /* status */
      mode_sq_ready = SQ_READY_END;
      mode_sq_time = 0.f;
