...
void gyro_fun(void)
{
  ...
  //	xv_gyro.gyro_yaw2		=	integrator_f( xv_gyro.gyro_data3_flt/RTC_TICK, xv_gyro.gyro_yaw2, 180.f ); // 1800->180
  // 130430

  /***	check fall down	for servo off		***/
  //	xv_gyro.gyro_roll2	=	(1.0f - xp_gyro.gyro_omega * RTC_TIME_SEC ) * xv_gyro.gyro_roll2 + xp_gyro.gyro_omega *
  // RTC_TIME_SEC * xv_acc.acc_roll2
  //							- RTC_TIME_SEC * xv_gyro.gyro_data1;
  //	xv_gyro.gyro_pitch2	=	(1.0f - xp_gyro.gyro_omega * RTC_TIME_SEC ) * xv_gyro.gyro_pitch2 + xp_gyro.gyro_omega *
  // RTC_TIME_SEC * xv_acc.acc_pitch2
...
void gyro_init(void)
{
  ...
  xv_gyro.gyro_data1 = xv_gyro.gyro_data2 = xv_gyro.gyro_data3 = xv_gyro.gyro_data1_d = xv_gyro.gyro_data2_d =
      xv_gyro.gyro_data3_d = xv_gyro.gyro_data1_flt = xv_gyro.gyro_data2_flt = xv_gyro.gyro_data3_flt =
          xv_gyro.gyro_data3_flt2 = xv_gyro.gyro_roll = xv_gyro.gyro_pitch = xv_gyro.gyro_yaw = xv_gyro.gyro_yaw2 =
              xv_gyro.deg_foot_roll = xv_gyro.deg_foot_pitch = xv_gyro.deg_hip_roll = xv_gyro.deg_hip_pitch =
                  xv_gyro.deg_arm_roll = xv_gyro.deg_arm_pitch = xv_gyro.deg_waist_pitch = xv_gyro.deg_waist_yaw =
                      xv_gyro.yaw_cntl_ref = xv_gyro.yaw_cntl_fb = 0.f;

  xv_gyro.gyro_roll2 = xv_gyro.gyro_pitch2 = 0.f;
...
void gyro_cntr_fun(void)
{
  ...
  if (flag_gyro.vib_auto == ON && flag_gyro.vib == ON)
  {
    ...
    double ratio = 1.0;
    if (len != 0)
      ratio = fabs(xv_joy.walk_x_percent / len);
