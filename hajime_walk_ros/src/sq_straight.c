...
int sq_straight()
{
  ...
  switch (mode_sq_straight)
  {
    case SQ_STRAIGHT: /*	straight position	*/
      /* action */
      xv_data_x_r.time = xv_data_y_r.time = xv_data_y_r2.time = xv_data_z_r.time = xv_data_x_l.time = xv_data_y_l.time =
          xv_data_y_l2.time = xv_data_z_l.time = xv_mv_straight_time;
    ...
    case SQ_STRAIGHT2: /*	straight position	*/
      /* action */
      xv_data_pitch.time = xv_data_roll2.time = xv_mv_straight_time;

      xv_data_pitch.pos = xv_data_roll2.pos = 0.f;
    ...
    case SQ_STRAIGHT3: /*	straight position	*/
      /* action */
      xv_data_d[0].time = xv_data_d[1].time = xv_data_d[2].time = xv_data_d[3].time = xv_data_d[4].time =
          xv_data_d[5].time = xv_data_d[6].time = xv_data_d[7].time = xv_mv_straight_time;

      xv_data_d[0].pos = xv_data_d[1].pos = xv_data_d[2].pos = xv_data_d[3].pos = xv_data_d[4].pos = xv_data_d[5].pos =
          xv_data_d[6].pos = xv_data_d[7].pos = 0.f;
    ...
    case SQ_STRAIGHT4: /*	straight position	*/
      /* action */
      xv_data_d[8].time = xv_data_d[9].time = xv_data_d[10].time = xv_data_d[11].time = xv_data_d[12].time =
          xv_data_d[13].time = xv_mv_straight_time;

      xv_data_d[8].pos = xv_data_d[9].pos = xv_data_d[10].pos = xv_data_d[11].pos = xv_data_d[12].pos =
      ...
      xv_data_d[ARM_PITCH_L].pos = xv_data_d[ARM_PITCH_R].pos = xp_mv_straight.arm_sh_pitch;
    ...
    case SQ_STRAIGHT5: /*	straight position	*/
      ...
      {
        xv_data_d[HEAD_YAW].time = xv_data_d[HEAD_PITCH].time = xv_mv_straight_time;
        xv_data_d[HEAD_YAW].pos = xv_data_d[HEAD_PITCH].pos = 0.f;
      }

      xv_data_d[ELBOW_PITCH_L].time = xv_data_d[SPARE17].time = xv_data_d[ELBOW_PITCH_R].time =
